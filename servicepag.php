...
join imagesofservice as ios on si.service_ID = ios.serviceID where si.service_ID= '$sid'");
            ...
            <button class="buttonNext" onclick="nextImage()">Next</button></section>
            <!-- test -->
            ...
            <div id="service-modal" class="modal">
                <div class="modal-content">
                    ...
                    <form method="post" action="requestService.php" style="display: inline;">
                        ...
                        <input type="datetime-local" id="start-date" name="start_date" required><br><br>

                        <label for="end-date">End Date:</label><br>
                        <input type="datetime-local" id="end-date" name="end_date" required><br><br>
                        ...
                        <button type="submit" name='ord' class="buttonReq" value="<?php echo "$sid"; ?>">Submit Request</button>
                    </form>
                    <button class="modal-close-btn">Close</button><br><br>
